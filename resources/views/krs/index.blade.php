...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <h2 class="text-xl font-bold text-gray-800 mb-4 md:mb-0">Data KRS Mahasiswa</h2>
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b">
                    ...
                    <th class="text-left py-3 px-4 font-medium text-gray-700">Prodi</th>
                    ...
                    <th class="text-left py-3 px-4 font-medium text-gray-700">Total SKS</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-4 px-4 text-gray-700">202310001</td>

                    <td class="py-4 px-4 text-gray-700">Teknik Informatika</td>

                    <td class="py-4 px-4 text-gray-700">Semester 3</td>
                    ...
                    <td class="py-4 px-4">
                        <div class="flex space-x-2">
                            <button class="text-blue-600 hover:text-blue-800" title="Detail KRS">
                                <i class="fas fa-eye"></i>
                            </button>
                            <button class="text-green-600 hover:text-green-800" title="Edit KRS">
                                <i class="fas fa-edit"></i>
                            </button>
                            <button class="text-red-600 hover:text-red-800" title="Hapus KRS">
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-4 px-4 text-gray-700">202310002</td>

                    <td class="py-4 px-4 text-gray-700">Sistem Informasi</td>

                    <td class="py-4 px-4 text-gray-700">Semester 5</td>
    ...
    <div class="flex justify-between items-center mt-6">
        <div class="text-gray-500 text-sm">
            Menampilkan 2 dari 100 data KRS
        </div>
        <div class="flex space-x-2">
