                        ...
                        <table class="w-full text-sm text-left">
                            ...
                            <tbody class="divide-y">
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-gray-800 font-semibold">Dr. Ahmad Santoso</td>
                                    <td class="px-6 py-4 text-gray-600">ahmad@unpam.ac.id</td>
                                    <td class="px-6 py-4 text-gray-600">1234567890</td>
                                    <td class="px-6 py-4 text-gray-600">Teknik Informatika</td>
                                    <td class="px-6 py-4">
                                        <span
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex justify-center gap-2">
                                            ...
                                            <a href="#"
                                                class="px-3 py-2 rounded-lg bg-yellow-50 text-yellow-600 hover:bg-yellow-100 transition">
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-gray-800 font-semibold">Siti Nur Aisyah, M.Kom</td>
                                    <td class="px-6 py-4 text-gray-600">siti@unpam.ac.id</td>
                                    <td class="px-6 py-4 text-gray-600">0987654321</td>
                                    <td class="px-6 py-4 text-gray-600">Sistem Informasi</td>
                                    <td class="px-6 py-4">
                                        <span
                                            class="px-3 py-1 rounded-full text-xs bg-green-100 text-green-700 font-semibold">
                                            Aktif
                                ...
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 text-gray-800 font-semibold">Budi Pratama, M.T</td>
                                    <td class="px-6 py-4 text-gray-600">budi@unpam.ac.id</td>
                                    <td class="px-6 py-4 text-gray-600">1122334455</td>
                                    <td class="px-6 py-4 text-gray-600">Manajemen</td>
                                    <td class="px-6 py-4">
                                        <span
                                            class="px-3 py-1 rounded-full text-xs bg-yellow-100 text-yellow-700 font-semibold">
                                            Cuti
                                        </span>
                                    </td>
                                    <td class="px-6 py-4">
