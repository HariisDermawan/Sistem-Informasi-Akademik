...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <h2 class="text-xl font-bold text-gray-800 mb-4 md:mb-0">Daftar Jadwal Perkuliahan</h2>

        <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 w-full md:w-auto">

            <!-- Search -->
            <div class="relative w-full sm:w-64">
                <input type="text" placeholder="Cari dosen / mata kuliah / ruangan..."
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b">
                    ...
                    <th class="text-left py-3 px-4 font-medium text-gray-700">Ruangan</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="py-4 px-4 font-medium text-gray-800">TI101</td>

                    <td class="py-4 px-4">
                        <p class="font-medium text-gray-800">Algoritma & Pemrograman</p>
                        <p class="text-sm text-gray-500">3 SKS</p>
                    </td>
                    ...
                    <td class="py-4 px-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-gray-800">Dr. Andi Saputra</p>
                ...
                <!-- Row 2 -->
                <tr class="border-b hover:bg-gray-50">
                    <td class="py-4 px-4 font-medium text-gray-800">SI205</td>
                    ...
                    <td class="py-4 px-4">
                        <div class="flex items-center">
                            ...
                            <div>
                                <p class="font-medium text-gray-800">Maya Wulandari, M.Kom</p>
    ...
    <div class="flex justify-between items-center mt-6">
        <div class="text-gray-500 text-sm">
            Menampilkan 2 dari 50 jadwal perkuliahan
        </div>
        <div class="flex space-x-2">
