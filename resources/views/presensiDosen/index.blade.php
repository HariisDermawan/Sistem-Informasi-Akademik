...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <div>
            <h2 class="text-xl font-bold text-gray-800">Presensi Dosen</h2>
            <p class="text-sm text-gray-500 mt-1">Kelola data presensi dosen & scan QR untuk absensi</p>
        </div>

        <div class="flex gap-3 mt-4 md:mt-0">
            <!-- Button Scan QR -->
            <button id="openScanQrBtn"
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        ...
        <div class="relative w-full md:w-80">
            <input type="text" placeholder="Cari dosen / NIDN / mata kuliah..."
        ...
        <table class="w-full border border-gray-200">
            <thead>
                <tr class="bg-gray-50 border-b">
                    ...
                    <th class="text-left py-3 px-4 font-medium text-gray-700">Dosen</th>
                    <th class="text-left py-3 px-4 font-medium text-gray-700">NIDN</th>
            ...
            <tbody id="presensiTbody">
                ...
                <tr class="border-b hover:bg-gray-50">
                    ...
                    <td class="py-4 px-4 text-gray-700">Dr. Ahmad Fauzi</td>
                    <td class="py-4 px-4 text-gray-700">1234567890</td>
                    ...
                    <td class="py-4 px-4 text-green-800 font-medium bg-green-100 px-2 py-1 rounded-full">Hadir</td>
...
<!-- MODAL SCAN QR FULL CAMERA -->
<div id="scanQrModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-xl shadow-lg w-full max-w-2xl h-[80vh] p-6 relative flex flex-col">
        <button id="closeScanQrBtn" class="absolute top-3 right-3 text-gray-500 hover:text-gray-800 z-10">
            <i class="fas fa-times text-lg"></i>
        </button>

        <h3 class="text-lg font-bold text-gray-800 mb-2 z-10">Scan QR Presensi Dosen</h3>
        <p class="text-sm text-gray-500 mb-4 z-10">Arahkan kamera ke QR Code untuk absensi otomatis</p>

        <!-- Video Kamera Full -->
        <div class="flex-1 w-full">
            <video id="qrVideo" class="w-full h-full rounded-lg border object-cover" autoplay></video>
        </div>
    </div>
</div>
...
const closeScanQrBtn = document.getElementById('closeScanQrBtn');
const qrVideo = document.getElementById('qrVideo');
let stream;

// Buka kamera saat klik Scan QR
openScanQrBtn.addEventListener('click', async () => {
    scanQrModal.classList.remove('hidden');
    scanQrModal.classList.add('flex');
    ...
    try {
        ...
        scanQrModal.classList.remove('flex');
    }
});
...
closeScanQrBtn.addEventListener('click', closeModal);
scanQrModal.addEventListener('click', e => {
    if(e.target === scanQrModal) closeModal();
});
</script>
