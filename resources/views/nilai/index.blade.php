...
<div class="bg-white rounded-xl shadow-md p-6 mb-6">
    ...
    <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
        <h2 class="text-xl font-bold text-gray-800 mb-4 md:mb-0">Daftar Nilai Mahasiswa</h2>

        <div class="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4 w-full md:w-auto">

            <!-- Search -->
            <div class="relative w-full sm:w-64">
                <input type="text" placeholder="Cari nama / NIM / mata kuliah..."
        ...
        <table class="w-full">
            <thead>
                <tr class="bg-gray-50 border-b">
                    ...
                    <th class="text-left py-3 px-4 font-medium text-gray-700">Tugas</th>
                    <th class="text-left py-3 px-4 font-medium text-gray-700">UTS</th>
                    <th class="text-left py-3 px-4 font-medium text-gray-700">UAS</th>
            ...
            <tbody>
                ...
                <tr class="border-b hover:bg-gray-50">
                    <td class="py-4 px-4 font-medium text-gray-800">20230001</td>
                    ...
                    <td class="py-4 px-4">
                        ...
                        <p class="text-sm text-gray-500">TI101 • 3 SKS</p>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700">80</span>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700">75</span>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700">85</span>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">80</span>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">A</span>
                    </td>
                ...
                <!-- Row 2 -->
                <tr class="border-b hover:bg-gray-50">
                    <td class="py-4 px-4 font-medium text-gray-800">20230002</td>
                    ...
                    <td class="py-4 px-4">
                        ...
                        <p class="text-sm text-gray-500">SI205 • 3 SKS</p>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700">70</span>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700">65</span>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-gray-100 text-gray-700">78</span>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-blue-100 text-blue-800">71</span>
                    </td>

                    <td class="py-4 px-4">
                        <span class="px-3 py-1 rounded-full text-sm font-medium bg-yellow-100 text-yellow-800">B</span>
                    </td>
    ...
    <div class="flex justify-between items-center mt-6">
        <div class="text-gray-500 text-sm">
            Menampilkan 2 dari 120 data nilai
        </div>
        <div class="flex space-x-2">
